        ...
        private void StartPlayback()
        {
            try
            {
                if (Playlist.CurrentTrackName == string.Empty)
                {
                    ...
                    var currenttrackname = applicationSettingsHelper.ReadSettingsValue(Constants.CurrentTrack);
                    var currenttrackposition = applicationSettingsHelper.ReadSettingsValue(Constants.Position);
